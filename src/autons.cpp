...
void skills() {
  chassis.pid_turn_set({-15_in, 30_in}, fwd, 127);
  chassis.pid_wait();
  intakingStore(127);
  chassis.pid_odom_set({{-15_in, 30_in}, fwd, 127});
  chassis.pid_wait();
  toggleDoinker();

  chassis.pid_odom_set({{-15_in, 25_in}, rev, 127});
  chassis.pid_wait();

  chassis.pid_turn_set({0_in, 35_in}, rev, 127);
  chassis.pid_wait();
  chassis.pid_odom_set({{0_in, 35_in, 45_deg}, rev, 127});
  chassis.pid_wait();
